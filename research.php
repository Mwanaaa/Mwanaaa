...
<body>
    ...
    <!-- Main Section -->
    <main>
        <h1>Register for Research projects</h1>
        <p>Join us for a Research project  to promote a clean and healthy environment. All students and staff are welcome to participate. Gloves and bags will be provided.</p>
