...
<body>
    ...
    <!-- Main Section -->
    <main>
        <h1>Register for Campus Clean-Up</h1>
        <p>Join us for a campus-wide clean-up event to promote a clean and healthy environment. All students and staff are welcome to participate. Gloves and bags will be provided.</p>
