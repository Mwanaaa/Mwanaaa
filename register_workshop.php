...
if(isset($_POST['submit'])){
    ...
    $sql= "insert into registations (Full_name, email, phone , comments ) values('$name','$email','$phone','$comments')";
...
<head>
    ...
    <title>Register for Sustainability Workshop - Green Guardians of MUST</title>
...
<body>
    ...
    <main>
        <h1>Register for Sustainability Workshop</h1>
        <p>Attend our sustainability workshop to learn about sustainable practices and how to implement them in your daily life. Open to all students and staff.</p>
        <form action="register_workshop.php" method="post">
